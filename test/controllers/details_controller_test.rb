...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference("Detail.count") do
      post details_url, params: { detail: { Designation: @detail.Designation, Name: @detail.Name, age: @detail.age, gender: @detail.gender } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { Designation: @detail.Designation, Name: @detail.Name, age: @detail.age, gender: @detail.gender } }
